...
def tarjeta() -> rx.Component:
    return rx.vstack(
        rx.avatar(src="ivan.webp", fallback="IG", size="8",
                  alt="Imagen del creador del sitio"),
        rx.heading("Jorge Vejarano", size="8"),
        rx.badge("Frontend Developer", radius="large", variant="soft",
                 color_scheme="gray", size="10", padding="5px 10px", font_weigh="bold"),
        rx.divider(
            size="4",
            width="80%",
        ),
        rx.flex(
            rx.flex(
                ...
                rx.flex(
                    ...
                    rx.heading("jvejarano@outlook.com", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
                gap="10px",
            ...
            rx.flex(
                rx.card(
                    rx.icon(tag="smartphone", color="gold",
                                width="100%", height="100%"),
                    width="40px",
                    height="40px",
                    align_iterms="center",
                ...
                rx.flex(
                    rx.heading("MOBILE", size="1", font_weight="300"),
                    rx.heading("+591 78290880", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
            ...
            rx.flex(
                rx.card(
                    rx.icon(tag="map-pin", color="gold",
                                width="100%", height="100%"),
                    width="40px",
                    height="40px",
                    align_iterms="center",
                ...
                rx.flex(
                    ...
                    rx.heading("TRINIDAD, BOLIVIA", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
            ...
            rx.flex(
                rx.card(
                    rx.icon(tag="calendar-days", color="gold",
                                width="100%", height="100%"),
                    width="40px",
                    height="40px",
                    align_iterms="center",
                ...
                rx.flex(
                    ...
                    rx.heading("JANUARY 28, 1980", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
        ...
        rx.flex(
            rx.link(rx.icon(tag="linkedin", color="white", size=20, _hover={
                    "color": "gold"}), href="https://www.linkedin.com/in/jorgevejarano", is_external=True),
            rx.link(rx.icon(tag="github", color="white", size=20, _hover={
                    "color": "gold"}), href="https://github.com/jvejarano", is_external=True),
            rx.link(rx.icon(tag="instagram", color="white", size=20, _hover={
                    "color": "gold"}), href="https://www.instagram.com/j.vejarano", is_external=True),
            direction="row",
            spacing="5",
        ),
        spacing="5",
...
def tarjeta_tablet() -> rx.Component:
    return rx.flex(
        rx.flex(
            ...
            rx.badge("Software Developer", radius="large", variant="soft",
                     color_scheme="gray", size="10", padding="5px 10px", font_weigh="bold"),
            rx.flex(
                rx.link(rx.icon(tag="linkedin", color="white", size=20, _hover={
                        "color": "gold"}), href="https://www.linkedin.com/in/ivangallardog/", is_external=True),
                rx.link(rx.icon(tag="github", color="white", size=20, _hover={
                        "color": "gold"}), href="https://github.com/IvanGallardoG", is_external=True),
                rx.link(rx.icon(tag="instagram", color="white", size=20, _hover={
                        "color": "gold"}), href="https://www.instagram.com/ivangallardog/", is_external=True),
                direction="row",
                spacing="5",
                width="100%",
                align="center",
        ...
        rx.flex(
            rx.flex(
                ...
                rx.flex(
                    rx.heading("EMAIL", size="1", font_weight="300"),
                    rx.heading("ivangallardog@icloud.com",
                               size="2", font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
                gap="10px",
            ...
            rx.flex(
                ...
                rx.flex(
                    ...
                    rx.heading("+52 4921076419", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
            ...
            rx.flex(
                ...
                rx.flex(
                    rx.heading("LOCATION", size="1", font_weight="300"),
                    rx.heading("GUADALAJARA, MEXICO", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
            ...
            rx.flex(
                ...
                rx.flex(
                    rx.heading("BIRTHDAY", size="1", font_weight="300"),
                    rx.heading("JUNE 15, 1999", size="2",
                               font_weight="500", color="white"),
                    direction="column",
                    justify="center",
                ),
        ...
        rx.accordion.item(
            ...
            content=rx.vstack(
                ...
                rx.flex(
                    rx.flex(
                        rx.card(
                            rx.icon(tag="mail", color="gold", display="block",
                                    key=Refrescar.refresh, width="100%", height="100%"),
                            width="40px",
                            height="40px",
                            align_items="center",
                        ),
                    ...
                    rx.flex(
                        rx.card(
                            rx.icon(tag="smartphone", color="gold", display="block",
                                    key=Refrescar.refresh, width="100%", height="100%"),
                            width="40px",
                            height="40px",
                            align_items="center",
                    ...
                    rx.flex(
                        rx.card(
                            rx.icon(tag="map-pin", color="gold", display="block",
                                    key=Refrescar.refresh, width="100%", height="100%"),
                            width="40px",
                            height="40px",
                            align_items="center",
                    ...
                    rx.flex(
                        rx.card(
                            rx.icon(tag="calendar-days", color="gold", display="block",
                                    key=Refrescar.refresh, width="100%", height="100%"),
                            width="40px",
                            height="40px",
                            align_items="center",
...
def button_mobile(id: int, label: str) -> rx.Component:
    return rx.button(
        ...
        font_size="2em",
        color=rx.cond(ButtonState.active_button == id, "gold", "white"),
        on_click=[lambda: ButtonState.set_active_button(
            id), DrawerState.toggle_drawer],
    )
...
def drawer_mobile() -> rx.Component:
    return rx.drawer.root(
        rx.drawer.trigger(rx.button(rx.icon(tag="menu", size=30, on_click=DrawerState.toggle_drawer), style={
                          "outline": "none", "border": "none"}), position="fixed", top="1em", right="1em", style={"z_index": "10000"}, background_color="transparent"),
        rx.drawer.overlay(z_index="5", on_click=DrawerState.toggle_drawer, style={
...
def about() -> rx.Component:
    return rx.flex(
        ...
        rx.flex(
            rx.card(
                rx.icon(tag="brain-circuit", color="gold",
                        width="100%", height="100%"),
                width="50px",
                height="50px",
                align_items="center",
        ...
        rx.center(
            rx.card(
                rx.vstack(
                    rx.flex(
                        rx.text(rx.text.strong("Python"),
                                " 80%", colot="white"),
                        rx.divider(size="4", width="80%", height="8px", border_radius="5px",
                                   background="linear-gradient(to right, gold, orange)"),
                        direction="column",
                        width="100%",
                        spacing="1",
                    ...
                    rx.flex(
                        ...
                        rx.divider(size="4", width="60%", height="8px", border_radius="5px",
                                   background="linear-gradient(to right, gold, orange)"),
                        direction="column",
                        width="100%",
                        spacing="1",
                    ...
                    rx.flex(
                        rx.text(rx.text.strong("HTML & CSS"),
                                " 70%", colot="white"),
                        rx.divider(size="4", width="70%", height="8px", border_radius="5px",
                                   background="linear-gradient(to right, gold, orange)"),
                        direction="column",
                        width="100%",
                        spacing="1",
                    ...
                    rx.flex(
                        rx.text(rx.text.strong("Flutter, Kotlin, Swift"),
                                " 40%", colot="white"),
                        rx.divider(size="4", width="40%", height="8px", border_radius="5px",
                                   background="linear-gradient(to right, gold, orange)"),
                        direction="column",
                        width="100%",
                        spacing="1",
        ...
        rx.center(
            rx.card(
                rx.grid(
                    rx.box(rx.heading("Problem Solving", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
                    rx.box(rx.heading("Teamwork", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
                    rx.box(rx.heading("Adaptability", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
                    rx.box(rx.heading("Proactivity", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
                    rx.box(rx.heading("Decision-making", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
                    rx.box(rx.heading("Time Management", color="gold", size="6"), text_align="center",
                           border_radius="5px", padding="10px", background_color="#44444455"),
...
def resume() -> rx.Component:
    return rx.flex(
        ...
        rx.flex(
            rx.card(
                rx.icon(tag="book-open", color="gold",
                        width="100%", height="100%"),
                width="50px",
                height="50px",
                align_items="center",
        ...
        tarjeta_resume("Instituto Politécnico Nacional",
                       "2017 - 2021", "Mechatronics Engineering"),
        rx.link(rx.button("View Final Project", color_scheme="gold", style={
                "outline": "none", "border": "none"}), href="https://drive.google.com/file/d/1EYeZTXzU90ggiaDfGiPEGpX6VhZco5xe/view?usp=drive_link", is_external=True, padding_left="70px", style={"outline": "none", "border": "none"}),
        rx.spacer(),
        rx.flex(
            rx.card(
        ...
        tarjeta_resume("FOXCONN | Test Engineer", "October 2023 - Present",
                       "I handle preventive and corrective maintenance, conduct tests, and manage Linux test environments. I automate tasks with scripts, collaborate with teams, and document procedures for efficiency and reliability."),
        tarjeta_resume("FOXCONN | Program Engineer", "May 2022 - October 2023",
                       "I manage the programming of integrated components for electronic boards, oversee label printing, and maintain printers and automatic programming machines. I handle inventory control for parts, tags, and electronic boards, and implement programs to reduce software loading errors."),
        tarjeta_resume("IPN | Engineer Intern (Control Systems)", "March 2021 - October 2021",
                       "I installed a new hydraulic pump, created wiring diagrams for sensors and actuators, and programmed the PLC using ladder logic."),
        rx.spacer(),
        rx.flex(
            rx.card(
                rx.icon(tag="badge-check", color="gold",
                        width="100%", height="100%"),
                width="50px",
                height="50px",
                align_items="center",
        ...
        rx.center(rx.link(rx.button("Download CV", color_scheme="gold", style={
                  "outline": "none", "border": "none"}), href="https://drive.usercontent.google.com/download?id=12T-tgLazQbQin80lyuN-XsJnuYUQly7p&export=download&authuser=0&confirm=t&uuid=edcf675b-f818-437c-8f8e-182d94adfa6d&at=APZUnTXrtl_uH4GfdSexzpZloAfy:1722800175218", is_external=False, style={"outline": "none", "border": "none"}), width="100%"),
        direction="column",
        spacing="5",
        justify="center",
        align="baseline",
    ...
    return rx.flex(
        rx.hover_card.root(
            rx.hover_card.trigger(
                rx.image(src=imagen, on_click=verModal.val(
                    imagen), _hover={"opacity": "0.8"}),
            ),
...
class formSubmit(rx.State):
    ...
    def genLink(self, form_data: dict):
        ...
        self.link = self.link + \
            ...
            self.form_data["last_name"] + "%0A"
        self.link = self.link + "I'm interested in " + \
            self.form_data["option"] + "%0A"
        ...
        rx.center(
            rx.form(
                rx.vstack(
                    ...
                    rx.center(rx.button("Submit", type="submit", color_scheme="gold", style={
